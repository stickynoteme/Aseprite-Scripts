----------------------------------------------------------------------
-- Alighment Helper Script Top Left
-- Based on CenterSelectionOOnCanvas by Copyright 2020 Geoff Beier <geoff@tuxpup.com>
...
new_y = spr.bounds.height/2 - sel.bounds.height/2 + alignData.y_offset
y_dir = "down"
y_distance = 0
